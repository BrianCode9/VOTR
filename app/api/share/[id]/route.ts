import { shareGET } from "@/lib/api/handlers/share"

/**
 * /api/share/:id
 *
 * The unversioned alias of /api/v1/share/:id. Same handler object, so the two cannot drift
